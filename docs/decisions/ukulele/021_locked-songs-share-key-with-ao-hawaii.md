...
本体の「performance（お手本の ABC）」は、五線譜の出どころが無い鍵付きの曲では省けるようにした。
Noho Paipai の歌詞カードにはコードと歌詞しか無く、持ち主は合成のお手本より Apple Music の録音の埋め込みを選んだ。
経緯と代替案は DDR 022。
...
- 同日夜に歌詞カードが届き、歌詞コード譜と意味を暗号化して置いた。お手本は DDR 022 のとおり置かず、録音の埋め込みで代えた
