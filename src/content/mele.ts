...
export const MELE: MeleMeta[] = [
  ...
  },
  {
    ...
    background: [
      "Emerson『Unwritten Literature of Hawaii』（1909）の p.55 に、支度部屋から広間へ出る ʻōlapa の歌として全文と英訳（Tiring Song）が載る。pāʻū を着ける長い詠唱のあとに置かれ、kumu の答えの歌を挟んで lei の歌（Ke Lei Maila ʻo Kaʻula）へ続く。",
