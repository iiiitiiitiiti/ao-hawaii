...
export const COURSES: Course[] = [
  {
    ...
    lessons: lessons("aina", [
      ["ハワイ諸島の成り立ち", "ホットスポットと太平洋プレートの動きから、島が北西ほど古い理由と島の一生（盾状火山から環礁へ）を説明できる"],
      ["島ごとの地形と気候", "貿易風が作る風上・風下の差を理由から説明し、主要8島の面積と最高峰、気候の特徴を言える"],
  ...
  },
  {
    ...
    lessons: lessons("hula", [
      ...
      ["カヒコとアウアナ", "kahiko と ʻauana の分岐点を伴奏と楽器で説明し、hula pahu が haʻa（heiau の儀礼）に結びつくという Kaeppler の整理を言える", 15],
      ...
      ["ハーラウ・クムフラ・ʻūniki", "hālau の語義と系譜の考え方、ʻūniki と ʻailolo の意味、kuahu の作法として原典に書かれていることと流派差の範囲を説明できる", 15],
      ["現在の潮流", "Merrie Monarch の歴史と直近3年の結果を言え、Nā Hōkū Hanohano の審査制部門とハワイ語復興との結びつき、日本への広がりを説明できる", 15],
      ["手で語る — Emerson が書き留めた所作", "kuhi の語義と ʻōlohe の請願での位置を言え、Emerson（1909）が記録した kumu の教え方の順序と手の型を5つ以上、流派差への Emerson 自身の注記つきで説明できる", 15],
    ]),
  },
  {
    slug: "olelo",
    ...
    lessons: lessons("olelo", [
      ...
      ["名詞文と場所文", "ʻO 文・He 文・Aia 文を作り分け、i と ma がなぜ割り切れないかを出典つきで説明できる", 15],
      ...
      ["歌の言葉 — 小辞・重複・歌だけの形", "句末の nō・hoʻi・paha と3つの lā を読み分け、重複の意味の向きと、歌だけに出る aʻe・aʻo を説明できる", 20],
    ]),
  },
];
