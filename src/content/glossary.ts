...
export const GLOSSARY: Term[] = [
  ...
  { id: "waiau", hawaiian: "Waiau", meaning: "Mauna Kea 山頂近くの湖（13,020 ft）。同名の女神の名でもある", note: "普通名詞 waiau は「水の絶えない場所、いつでも水浴できる水」（Andrews・Parker の辞書。PE 1986 には見出しが無い）", category: "moolelo", sourceUrl: "https://wehe.hilo.hawaii.edu/?q=waiau", checkedAt: "2026-09-21" },
  ...
  { id: "kumu-hula", hawaiian: "kumu hula", meaning: "フラの師。kumu の第一義は「源・幹」で、「教師」は後代の用法", note: "PE の見出しは kumu（kumu hula はその項の複合語）", category: "hula", sourceUrl: "https://wehe.hilo.hawaii.edu/?q=kumu", checkedAt: "2026-09-21" },
  ...
  { id: "amakihi", hawaiian: "ʻamakihi", meaning: "ハワイミツスイの一群（PE は a group。Chlorodrepanis virens ほか）。黄緑色で、低地の個体群は鳥マラリアへの耐性を進化させつつある", category: "mea-ola", sourceUrl: "https://wehe.hilo.hawaii.edu/?q=%CA%BBamakihi", checkedAt: "2026-09-21" },
