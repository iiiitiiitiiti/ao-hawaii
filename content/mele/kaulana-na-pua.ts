 ...
 * 歌詞は Elbert & Mahoe の版（huapala.org 掲載）。逐語の意味は Pukui-Elbert 辞書（PE、wehewehe.org）で引いた。
...
export const body: MeleBody = {
      ...
      lines: [
        {
          ...
          words: [
            ...
            { w: "nā", gloss: "定冠詞・複数" },
            { w: "pua", gloss: "花。比喩で子ら・子孫", term: "pua" },
        ...
        },
        {
          ...
          words: [
            ...
            { w: "o", gloss: "〜の" },
            { w: "ka", gloss: "定冠詞・単数" },
            { w: "ʻāina", gloss: "土地、国", term: "aina" },
          ],
          ja: "揺るがず、この国の後ろに立つ",
          notes: [{ text: "ma hope o 〜 で「〜の後ろに」。場所名詞 hope を ma と o で挟む型。", lesson: "olelo/lesson-05" }],
        },
        {
        ...
        {
          haw: "Palapala ʻanunu me ka pākaha",
          words: [
            { w: "Palapala", gloss: "文書", term: "palapala" },
            { w: "ʻanunu", gloss: "強欲な（PE ʻālunu の項の異形 ʻanunu。Andrews・Parker 辞書は alunu の n 形とする）" },
            { w: "me", gloss: "〜とともに", term: "me" },
            { w: "ka", gloss: "定冠詞" },
            { w: "pākaha", gloss: "ゆすり、強奪（PE pākaha 1.）" },
          ],
          ja: "強欲と強奪の文書を携えて",
          notes: [{ text: "修飾する語は名詞のあとに置く。palapala ʻanunu で「強欲な文書」。" }],
        },
      ],
    },
    {
      lines: [
        ...
        },
        {
          ...
          notes: [{ text: "nā Hono a Piʻilani はマウイを指す詩句。", lesson: "aina/lesson-06" }],
        },
        {
      ...
      lines: [
        ...
        },
        {
          ...
          words: [
            ...
            { w: "sivila", gloss: "市民の（英語 civil から。PE の見出しは kīwila）" },
            { w: "aʻo", gloss: "〜の（o の歌での形）" },
    ...
    },
    {
      lines: [
        ...
        },
        {
          ...
          ja: "この国の権利を勝ち取った人の",
          notes: [
            { text: "Elbert & Mahoe はこの行を「who has won the rights of the land」と、前の行の Liliʻulani にかかる形で訳す。" },
        ...
        },
        {
          ...
          words: [
            ...
            { w: "ʻia", gloss: "受動の接尾辞", term: "ia-passive" },
            { w: "mai", gloss: "こちらへ（方向詞）", term: "mai-dir" },
            { w: "ana", gloss: "まだ続いている相" },
            { w: "ka", gloss: "定冠詞" },
            { w: "puana", gloss: "歌の主題", term: "puana" },
          ],
          ja: "歌の主題は、ここに語られた",
          notes: [{ text: "受動の ʻia、方向詞 mai、相の ana、主語 ka puana が1行に並ぶ。ʻŌlelo Hawaiʻi Lesson 04 の締めで読んだ行。", lesson: "olelo/lesson-04" }],
        },
        {
  ...
  kaona: [
    ...
    "第4連の石（pōhaku）が、別名 Mele ʻAi Pōhaku（石を食う歌）の由来。楽団員の「残されたもの、石、この土地の神秘の食物で満足する」という言葉を、そのまま歌詞にしている。政府の給金（puʻu kālā）より、土地そのものを取る、という宣言である。",
    "第2連は4つの島を昔の首長の名で呼ぶ。Hawaiʻi は Keawe、Maui は Piʻilani、Kauaʻi は Mano、Oʻahu は Kākuhihewa。島ごとの呼び名を並べることで、全土が一つになって応えていることを示す。",
  ],
  version:
    "Elbert & Mahoe『Nā Mele o Hawaiʻi Nei』の版（huapala.org 掲載）に拠る。第4連末は huapala では ka āina だが、ほかの行に合わせて ʻāina と書いた。第1連の ʻanunu は huapala では ʻānunu だが、PE では長い ā の ʻānunu はウリ科のつる植物の名なので、ʻālunu の異形として PE が示す ʻanunu と書いた（Nordyke & Noyes 1993 の再録も a に kahakō なし）。この版には最終連の別の行として「A kau hou ʻia e ke kalaunu」（再び王冠を戴かれるまで）がある。1893年の新聞掲載では、3月25日の初出と5月12日の訂正版とで第3・4連の行の順が違う（Stillman 1999）。PE の aʻe 5. の例文は第4連を「i ka puʻu kālā a ke aupuni」と引いていて、この版の o ke aupuni と1字違う。",
  sources: [
    { label: "huapala.org — Kaulana Nā Pua", url: "https://www.huapala.org/Kau/Kaulana_Na_Pua.html", note: "歌詞（Elbert & Mahoe の版）と英訳" },
    { label: "Pukui & Elbert, Hawaiian Dictionary（wehewehe.org）", url: "https://wehe.hilo.hawaii.edu/", note: "逐語の意味。aʻe 5.（歌での e の置き換え）、ē 2.、pākaha、pūlima、minamina ほか" },
    { label: "Andrews 1865 / Parker 1922（wehewehe.org）", url: "https://wehe.hilo.hawaii.edu/?q=%CA%BBanunu", note: "anunu を alunu の n 形とする" },
