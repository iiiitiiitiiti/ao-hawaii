...
export const body: MeleBody = {
      ...
      lines: [
        {
          ...
          words: [
            ...
            { w: "aʻo", gloss: "〜の（o を歌で置き換えた形。PE aʻo 2.）" },
            { w: "Hawaiʻi", gloss: "ハワイ" },
          ],
          ja: "名高きはハワイの花々（子ら）",
          notes: [
        ...
        },
        {
          ...
          words: [
            ...
            { w: "ʻānunu", gloss: "強欲な（ʻālunu の異形。Andrews・Parker 辞書は alunu の n 形とする）" },
            { w: "me", gloss: "〜とともに", term: "me" },
            { w: "ka", gloss: "定冠詞" },
            { w: "pākaha", gloss: "ゆすり、強奪（PE pākaha 1.）" },
          ],
          ja: "強欲と強奪の文書を携えて",
          notes: [{ text: "修飾する語は名詞のあとに置く。palapala ʻānunu で「強欲な文書」。" }],
        },
      ],
    },
    {
      ...
      lines: [
        {
          ...
          ja: "誰ひとり署名を記しはしない",
          notes: [
            { text: "この aʻe は方向詞ではない。PE は aʻe の5番目の意味を「歌で e を置き換えたもの」とし、この曲の第4連を例文に挙げる。", lesson: "olelo/lesson-04" },
  ...
  version:
    "Elbert & Mahoe『Nā Mele o Hawaiʻi Nei』の版（huapala.org 掲載）に拠る。第4連末は huapala では ka āina だが、ほかの行に合わせて ʻāina と書いた。この版には最終連の別の行として「A kau hou ʻia e ke kalaunu」（再び王冠を戴かれるまで）がある。1893年の新聞掲載では、3月25日の初出と5月12日の訂正版とで第3・4連の行の順が違う（Stillman 1999）。PE の aʻe 5. の例文は第4連を「i ka puʻu kālā a ke aupuni」と引いていて、この版の o ke aupuni と1字違う。",
  sources: [
    ...
    { label: "Andrews 1865 / Parker 1922（wehewehe.org）", url: "https://wehe.hilo.hawaii.edu/?q=%CA%BBanunu", note: "ʻānunu を alunu の n 形とする" },
